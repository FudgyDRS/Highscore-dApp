/*
    Description:
    Governance contract version 0.0.02
    Verified under 24KB:
    https://testnet.bscscan.com/address/0xc0dbc7A1Ffc96Fde4C8e595754c6C90141b26cCD#code
*/
...
contract SirLeonidus is ERC20, Ownable {
    ...
    event MintFromGamify(uint256 quanitity, address minter, address recipent);
    ...
    function mintFromGamify(uint256 _amount, address _to) external noreentry client {
        _mint(_to, _amount);

        emit MintFromGamify(_amount, msg.sender, _to);
        }
    ...
    function _transfer(address _from, address _to, uint256 _amount) internal override {
        ...
        if(tradingEnabled && _fee > 0) {
            ...
            if(reserve1 > 10 ** 19) {// if reserves > 10 BNB value
